...
public class MyAccountsPage extends Utility {
    ...
    public void enterFirstName() {
        sendTextToElement(firstName, "key ");
    }
    ...
    public void enterEMail() {
        ...
        generateRandomEmail(emailId, "Keyur@gmail.com");
    }

    public void enterPhoneNumber() {
        sendTextToElement(mobileNumber, "07438555939");
    }
    ...
    public void enterEmail() {
        sendTextToElement(emailId, "keyur@gmail.com");
    }
